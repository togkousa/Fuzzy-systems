...
% Adding rules - dv
controller = addmf(controller,'input',2,'VS','trimf',[-0.25 0 0.25]);
controller = addmf(controller,'input',2,'S','trimf', [0 0.25 0.5]);
controller = addmf(controller,'input',2,'M','trimf', [0.25 0.5 0.75]);
...
controller = addmf(controller,'input',3,'NS','trimf', [-180 -90 0]);
controller = addmf(controller,'input',3,'ZE','trimf', [-90 0 90]);
controller = addmf(controller,'input',3,'PS','trimf', [0 90 180]);
...
controller = addmf(controller,'output',1,'ZE','trimf', [-65 0 65]);
